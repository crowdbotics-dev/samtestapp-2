"""
Django settings for samtestapp_2 project.
...
ROOT_URLCONF = 'samtestapp_2.urls'
...
WSGI_APPLICATION = 'samtestapp_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samtestapp_2 API",
    "DESCRIPTION": "API documentation for samtestapp_2 App",
    "VERSION": "v1",
}
